...
slp_control_heatmap <- pathway_heatmap(abundance = abundance_desc %>% 
                  column_to_rownames("feature"), metadata = Control_metadata, group = "Sleep_problems")
slp_control_heatmap
...
ggsave(filename = "fig4_A_control_pca.png", slp_control_pca, 
       height = 6, width = 9)
